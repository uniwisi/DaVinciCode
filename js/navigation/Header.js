...
class Header extends React.PureComponent<void, HeaderProps, HeaderState> {
  ...
  //     : undefined;
  //   const title = this._getHeaderTitleString(props.scene);
  //   return (
  //     <View style={{ borderRightWidth: 1, borderRightColor: '#fff' }}>
  //       <HeaderBackButton
  //         onPress={() => {
  //           utils.onPageEnd(title);
  //           Picker.hide();
  //         }}
  ...
  render() {
    ...
    return (
      <View style={options.hideHeader ? [styles.statusBar, options.statusBarStyle] : {}}>
        {/** !options.hideHeader ? 
